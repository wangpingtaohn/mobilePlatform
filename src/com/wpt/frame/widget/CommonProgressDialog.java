...
public class CommonProgressDialog extends AlertDialog {
    ...
    public static CommonProgressDialog show(Context context, CharSequence title, CharSequence message) {
        return show(context, title, message, false);
    }

    public static CommonProgressDialog show(Context context, CharSequence title, CharSequence message, boolean indeterminate) {
        ...
        if (mProgressStyle == STYLE_HORIZONTAL) {
            ...
            mViewUpdateHandler = new Handler() {
                ...
                public void handleMessage(Message msg) {
                    ...
                    mProgressNumber.setText(mProgressNumberFormatter.format(progress, max));
